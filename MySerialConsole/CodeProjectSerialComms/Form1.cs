...
//Com Ports
        ...
        private void SetText(string text)
        {
            ...
            {
                this.rtbIncoming.SelectionStart = this.rtbIncoming.Text.Length;
        ...
        private void lblBreakStatus_Click(object sender, EventArgs e)
        {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            cboBaudRate.Items.Add(74880);
            cboBaudRate.Items.Add(115200);
            cboBaudRate.Items.Add(230400);
            cboBaudRate.Items.Add(250000);
            cboBaudRate.Items.Add(500000);
            cboBaudRate.Items.Add(1000000);
            cboBaudRate.Items.Add(2000000);

            cboBaudRate.Items.ToString();
            //get first item print in text
            cboBaudRate.Text = cboBaudRate.Items[17].ToString();
            ...
            //Item for endline
            comboBox1.Items.Add("No End Line");
            comboBox1.Items.Add("New Line");
            comboBox1.Items.Add("Carriage Return");
            comboBox1.Items.Add("Both NL & CR");
            //get the first item print it in the text 
